...
@Component({
  ...
  templateUrl: './discount-amount.component.html',
  styleUrl: './discount-amount.component.css'
})
export class DiscountAmountComponent {
  ...
  constructor(private decimalPipe: DecimalPipe) {}
    ...
    public barChartDiscountAmount: ChartType = 'bar';
  
    public barChartDiscountAmountData: ChartData<'bar'> = {
      labels: this.labels,
      datasets: [{
        label: 'Sales',
        data: this.dataset,
    ...
    public barChartDiscountAmountOptions: ChartOptions = {
