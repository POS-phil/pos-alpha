...
@Component({
  ...
  templateUrl: './net-payments.component.html',
  styleUrl: './net-payments.component.css'
})
export class NetPaymentsComponent {
  ...
  public barChartNetSales: ChartType = 'bar';

  public barChartSales: ChartData<'bar'> = {
    labels: this.labels,
    datasets: [{
      label: 'Sales',
      data: this.dataset,
