...
constructor(
  ...
  ngOnInit(): void {
    this.items = [ { label: 'Sizes' }]
    this.getCategories();

    this.cols = [
      { field: 'category', header: 'Category', filter: true, styleClass: 'category' },
      { field: 'name', header: 'Name', filter: true, styleClass: 'col-name' },
      { field: 'reference', header: 'Reference', filter: true, styleClass: 'col-name' },
      { field: 'option', header: 'Option', filter: true, styleClass: 'col-name' },
      { field: 'link-item', header: 'Link Item', filter: false, styleClass: 'col-item' },
